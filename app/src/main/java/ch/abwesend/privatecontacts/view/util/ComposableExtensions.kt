...
@Composable
fun getCurrentActivity(): AppCompatActivity? = LocalContext.current.getActivityRecursive()

private tailrec fun Context.getActivityRecursive(): AppCompatActivity? = when (this) {
